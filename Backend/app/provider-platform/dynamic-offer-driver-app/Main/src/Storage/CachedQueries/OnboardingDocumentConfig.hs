...
findByMerchantIdAndDocumentType :: (CacheFlow m r, EsqDBFlow m r) => Id Merchant -> DocumentType -> m (Maybe OnboardingDocumentConfig)
...
cacheOnboardingDocumentConfig :: (CacheFlow m r) => OnboardingDocumentConfig -> m ()
...
makeMerchantDocTypeKey :: Id Merchant -> DocumentType -> Text
...
clearCache :: Hedis.HedisFlow m r => Id Merchant -> DocumentType -> m ()
